...
public class TestObjects {
    ...
    public static final Tag CREATED_TAG_4 = new Tag( INIT_TEST_ID + 3,CREATE_TEST_TAG_4.getName());
    ...
    public static final TagTo CREATE_DTO_TAG_4 = new TagTo(CREATED_TAG_4.getId(), CREATED_TAG_4.getName());
    ...
    public static final Author CREATED_AUTHOR_4 = new Author(INIT_TEST_ID + 3, CREATE_TEST_AUTHOR_4.getName(), CREATE_TEST_AUTHOR_4.getSurname());
    ...
    public static final AuthorTo CREATE_TEST_DTO_AUTHOR_4 = new AuthorTo(CREATED_AUTHOR_4.getId(), CREATE_TEST_AUTHOR_4.getName(), CREATE_TEST_AUTHOR_4.getSurname());
    ...
    public static final News EXPECTED_NEWS_1 = new News(INIT_TEST_ID, "News title 1", "Short text 1", "Full text 1",
            EXPECTED_AUTHOR_1, Arrays.asList(EXPECTED_TAG_1, EXPECTED_TAG_2));
    public static final News EXPECTED_NEWS_2 = new News(INIT_TEST_ID + 1, "News title 2", "Short text 2", "Full text 2",
            EXPECTED_AUTHOR_2, Arrays.asList(EXPECTED_TAG_1, EXPECTED_TAG_3));
    public static final News EXPECTED_NEWS_3 = new News(INIT_TEST_ID + 2, "News title 3", "Short text 3", "Full text 3",
            EXPECTED_AUTHOR_3, Collections.singletonList(EXPECTED_TAG_3));
    public static final News CREATE_TEST_NEWS_4 = new News(null, "Create", "create", "create test",
            EXPECTED_AUTHOR_3, Collections.singletonList(EXPECTED_TAG_3));
    public static final News CREATED_NEWS_4 = new News(INIT_TEST_ID + 3, CREATE_TEST_NEWS_4.getTitle(), CREATE_TEST_NEWS_4.getShortText(), CREATE_TEST_NEWS_4.getFullText(),
            CREATE_TEST_NEWS_4.getAuthor(), CREATE_TEST_NEWS_4.getTags());
    public static final News UPDATE_TEST_NEWS_5 = new News(INIT_TEST_ID + 4, "Update title", "Update TEST", "Update Test",
            EXPECTED_AUTHOR_3, Arrays.asList(EXPECTED_TAG_2, EXPECTED_TAG_3));
    ...
    public static final NewsTo CREATE_TEST_DTO_NEWS_4 = new NewsTo(CREATED_NEWS_4.getId(), CREATED_NEWS_4.getTitle(), CREATED_NEWS_4.getShortText(), CREATED_NEWS_4.getFullText(),
            EXPECTED_DTO_AUTHOR_3,
            Collections.singletonList(EXPECTED_DTO_TAG_3)
    );
