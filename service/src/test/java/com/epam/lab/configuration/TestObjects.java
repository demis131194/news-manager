...
public class TestObjects {
    ...
    public static final Author UPDATE_TEST_AUTHOR_5 = new Author(INIT_TEST_ID, "Update TEST", "Update Test");
    ...
    public static final News UPDATE_TEST_NEWS_5 = new News(INIT_TEST_ID, "Update title", "Update TEST", "Update Test");
